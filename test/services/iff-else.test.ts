...
describe('services iff - sync predicate, async hook', () => {
  ...
  it('calls async hook function if sync predicate truthy', () => {
    return iff(true, hookFcnAsync)(hook)
      // @ts-ignore
      .then((result1: any) => {
...
describe('services iff - async predicate, sync hook', () => {
  ...
  it('calls sync hook function if aync predicate truthy', () => {
    return iff(() => new Promise(resolve => resolve(true)), hookFcnSync)(hook)
      // @ts-ignore
      .then((result1: any) => {
        assert.deepEqual(result1, hookAfter);
        assert.equal(hookFcnSyncCalls, 1);
  ...
  it('does not call sync hook function if async predicate falsey', () => {
    return iff(() => new Promise(resolve => resolve(false)), hookFcnSync)(hook)
      // @ts-ignore
      .then((result1: any) => {
...
describe('services iff - async predicate, async hook', () => {
  ...
  it('calls async hook function if aync predicate truthy', () => {
    return iff(() => new Promise(resolve => resolve(true)), hookFcnAsync)(hook)
      // @ts-ignore
      .then((result1: any) => {
        assert.deepEqual(result1, hookAfter);
        assert.equal(hookFcnAsyncCalls, 1);
  ...
  it('does not call async hook function if async predicate falsey', () => {
    return iff(() => new Promise(resolve => resolve(false)), hookFcnAsync)(hook)
      // @ts-ignore
      .then((result1: any) => {
        assert.deepEqual(result1, hookBefore);
        assert.equal(hookFcnAsyncCalls, 0);
...
describe('services iff - sync predicate', () => {
  ...
  it('is passed hook as param', () => {
    return iff(predicateSync, hookFcnSync)(hook)
      // @ts-ignore
      .then((hook: any) => {
  ...
  it('a higher order predicate can pass more options', () => {
    return iff(predicateSync2({ z: 'z' }), hookFcnSync)(hook)
      // @ts-ignore
      .then((hook: any) => {
...
describe('services iff - async predicate', () => {
  ...
  it('is passed hook as param', () => {
    return iff(predicateAsync, hookFcnSync)(hook)
      // @ts-ignore
      .then((result1: any) => {
        assert.deepEqual(predicateHook, hookBefore);
        assert.deepEqual(result1, hookAfter);
  ...
  it('is resolved', () => {
    // @ts-ignore
    return iff(predicateAsyncFunny, hookFcnSync)(hook)
      // @ts-ignore
      .then((result1: any) => {
        assert.deepEqual(predicateHook, hookBefore);
        assert.deepEqual(result1, hookAfter);
  ...
  it('a higher order predicate can pass more options', () => {
    return iff(predicateAsync2({ y: 'y' }), hookFcnSync)(hook)
      // @ts-ignore
      .then((result1: any) => {
