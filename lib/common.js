...
exports.validateUsingPromise = exports.validateUsingCallback = exports.validateSync = exports.restrictToRoles = exports.debug = exports.setSlug = exports.setUpdatedAt = exports.setCreatedAt = undefined;
  ...
  var addFields = function addFields(data) {
    ...
    try {
      for (var _iterator = fields[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        (0, _utils.setByDot)(data, field, new Date());
      }
    } catch (err) {
