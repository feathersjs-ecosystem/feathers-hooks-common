...
var restrictToRoles = exports.restrictToRoles = function restrictToRoles(defaultRoles) {
  var rolesFieldName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'roles';
  var defaultIfOwner = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  var ownerFieldName = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'ownerId';
