...
/*
 ...
 after: {
   ...
   all: softDelete({ deletedAt: '...', skipProbeOnGet: true }), // If optimized get used.
 }
...
module.exports = function (options = {}) {
  ...
  return async function (context) {
    ...
    if (context.params.$ignoreDeletedAt) {
      return context;
    }
...
async function getActiveRecord (options, context) {
  const record = await (options.probeCall || defaultProbeCall)(context);
...
async function defaultProbeCall (context) {
