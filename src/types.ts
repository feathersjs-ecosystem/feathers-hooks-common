...
export type ContextFunction<T, H extends HookContext = HookContext> = (context: H) => T | Promise<T>

export type SyncPredicateFn<H extends HookContext = HookContext> = (context: H) => boolean
export type AsyncPredicateFn<H extends HookContext = HookContext> = (context: H) => Promise<boolean>
